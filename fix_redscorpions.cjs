...
constantsContent = constantsContent.replace(/"Blood Ravens", "Red Scorpions"/g, '"Blood Ravens"');
constantsContent = constantsContent.replace(/"Blood Ravens",\\s*"Red Scorpions"/g, '"Blood Ravens"');
constantsContent = constantsContent.replace(/"Blood Ravens",\\n\\s*"Red Scorpions"/g, '"Blood Ravens"');

// 1. CHAPTERS
constantsContent = constantsContent.replace(
  /"Flesh Tearers", "Blood Ravens"/g,
  '"Flesh Tearers", "Blood Ravens", "Red Scorpions"'
);
...
// 7. LIBRARIAN_PSYCHIC_POWERS (already replaced previously? Let's check with indexOf to only replace if needed)
if (!constantsContent.includes("Word of the Codex Astartes")) {
  constantsContent = constantsContent.replace(
...
// 8. CHAPTER_TRAPPINGS 
if (!constantsContent.includes("Icon of the Scorpion")) {
  constantsContent = constantsContent.replace(
...
// 9. RELIC_WARGEAR
if (!constantsContent.includes("Correction of Flesh")) {
  constantsContent = constantsContent.replace(
