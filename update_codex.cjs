...
// First let's extract the array elements. I'll just write out the complete array by hand from the old script to ensure I don't lose anything.
// No, it's safer to use the exact current contents except for the ones we're updating in the node script.
